...
public class AddPostActivity extends AppCompatActivity {
    ...
    //image picked constants
    private static final int IMAGE_PICKED_CAMERA_CODE = 300;
    private static final int IMAGE_PICKED_GALLERY_CODE = 400;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get data through intent fro previous activities' adapter
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)){
                    Toast.makeText(AddPostActivity.this, "Enter tittle...", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void updateWasWithImage(final String title, final String description, final String editPostId) {
        //post is with image, delete the previous post first
    ...
    private void loadPostData(String editPostId) {
        ...
        //get detail of post using id of the post
    ...
    private void pickFromGallery() {
        ...
        startActivityForResult(intent, IMAGE_PICKED_GALLERY_CODE);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        //this method is called when a user press Allow or Deny from permission request dialog
        //here i'm handling permission casea (Allow or Denied)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode== RESULT_OK){
            if (requestCode== IMAGE_PICKED_GALLERY_CODE){
